package ch03_class.basic.sec07.exam01.service;

import ch03_class.basic.sec07.exam01.vo.People;
...
//        TestVO test = new TestVO();
        // default 클래스인 TestVO는 다른 패키지여서 import 불가
...
//        System.out.println(v4);
    ...
    public void ex3(){
        ...
        // 성별 '남' -> '여'로 변경
        p.setGender('F');
        System.out.println("바뀐성별 : " + p.getGender());

        // ------------------------------------------------
        // 1) People 클래스의 toString() 오버라이딩 전
        // -> Object 의 toString() 호출
        System.out.println(p);
        System.out.println(p.toString());
        // print 수행시 참조변수명만 작성하는 경우
        // 자동으로 toString() 메서드를 호출해서 출력함

        // 2) People 클래스의 toString() 오버라이딩 후
        // -> 오버라이딩 된 자식(People)의 toString() 호출
