package ch02_conditional_loop_reference.basic.ch06.sec08.exam03;
...
public class Car {
    ...
    public void run() {
        ...
        while (this.isLeftGas()) {
            Car.gas--;
            System.out.println("달립니다.(gas잔량:" + Car.gas + ")");
        }
        System.out.println("멈춥니다.(gas잔량:" + Car.gas + ")");
