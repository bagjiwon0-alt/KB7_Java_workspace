...
public class ArrayExample {
    ...
    public static void main(String[] args) {
        ...
        // 1-1. 변수 선언
        int num;
        // Stack 영역에 int 자료형(4바이트)을 저장할 수 있는 공간
        // 4바이트를 생성(할당)하고 num이라는 이름을 부여
        ...
        // new int[3] : Heap 영역에 3칸짜리int[]을 생성(할당)

        // ** 생성된 int[]에는(arr말하는거) 시작 주소가 담긴다. **

        // arr    =    new int[3]; -> 인트배열
        // int[]   =    int[] -> 같은 자료형이기 때문에 대입 연산 가능!(둘다 인트배열)

        // heap 영역에 생성된 int[]의 시작 주소를 stack 영역에 생성된 arr 변수에 대입
        // -> arr 변수가 int[]배열을 참조하게 된다!

        // 2-3. 배열 요소 값 대입
        // arr은 int[] 참조변수지만
        // arr[0]은 int 자료형 변수이기 때문에 정수값 대입 가능
        arr[0] = 10;
        arr[1] = 20;
        arr[2] = 30;
